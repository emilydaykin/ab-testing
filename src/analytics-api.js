...
export const trackPageview = (params) => {
  console.log(
    `--> Tracking Pageview: ${params.event} for version ${params.version}. VisitorID: ${params.visitorID}`,
  );
};
...
export const trackEvent = (params) => {
  console.log(
    `--> Tracking Event: ${params.event} for version ${params.version}. VisitorID: ${params.visitorID}`,
  );
};
